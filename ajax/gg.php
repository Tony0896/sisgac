...
LEFT JOIN
(select * 
from Validado_verifi where unidad = '810'
ORDER BY fecha DESC
LIMIT 1 ) tb1
on tb0.ECO = tb1.unidad 
LEFT JOIN
(select * 
from Carga_gasolina where unidad = '810'
ORDER BY fecha DESC
LIMIT 1 ) tb2
...
{ 
    ...
    'holograma'=> $holograma, 'ul_verifi'=> $ul_verifi, 'periodo'=> $periodo, 'observaciones'=> $observaciones, 'f_recor'=> $f_recor,
    'km_final'=> $km_final, 'f_carga'=> $f_carga, 'km_final'=> $km_final, 'f_carga'=> $f_carga, 'km_carga'=> $km_carga, 
